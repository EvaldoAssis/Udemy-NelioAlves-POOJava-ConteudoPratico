...
public class Funcionario {
	...
	// Quando a composição for de 1 pra muitos, deve ser criada da maneira abaixo,
	// sendo que a lista a seguir não deve ser inserida no construtor
	...
	// Esse método não pode ser permitido, pois ele esta recebendo no parametro uma
	...
	public Double rendaTotal(int ano, int mes) {
		...
		// O laço funciona da seguinte forma: Para cada contrato c (nome da variavel) na
