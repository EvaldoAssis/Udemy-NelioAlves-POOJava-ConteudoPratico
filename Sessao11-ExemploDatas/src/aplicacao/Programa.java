...
public class Programa {
	...
	public static void main(String[] args) throws ParseException {
		...
		// O número de milissegundos desde a meia noite do dia 1 de janeiro de 1970 GMT (UTC), para nós está 3 horas atrasado
		Date x3 = new Date(0L);
		...
		System.out.println("--- Datas com formatação - Horário Brasil---");
		...
		System.out.println("--- Datas com formatação - Horário Greenwich ---");
